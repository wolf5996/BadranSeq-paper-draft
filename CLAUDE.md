...
All `@cite-key` references in `paper.qmd` must have a matching entry in `references.bib`. Current keys: `hao2024`, `stuart2019`, `butler2018`, `blancocarmona2022`, `mcinnes2018`, `wickham2016`, `zeileis2020`, `ovchinnikova2020`, `heumos2023`, `luecken2019`, `rcore2024`, `garnier2024`, `patil2021`, `brunson2020`.
