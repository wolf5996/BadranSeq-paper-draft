...
\begin{table}[htbp]
\centering
\caption{Comparison of default capabilities between Seurat and BadranSeq.}\label{tbl-comparison}
\begin{tabular}{@{}l c c@{}}
\toprule
\rowcolor{tableheader}
\textbf{Feature} & \textbf{Seurat} & \textbf{BadranSeq} \\
\midrule
Variance explained on PCA axes  & ---          & \checkmark \\
Cell borders                    & ---          & \checkmark \\
Cluster labels by default       & ---          & \checkmark \\
Split-panel silhouettes         & ---          & \checkmark \\
Publication theme               & ---          & \checkmark \\
Viridis feature plots           & ---          & \checkmark \\
Interactive cell selection      & Limited      & Additive / subtractive \\
Automatic rasterisation         & ---          & \checkmark \\
Statistical violin plots        & ---          & Kruskal--Wallis \\
Sankey / alluvial diagrams      & ---          & \checkmark \\
Tidy data extraction            & \texttt{FetchData} & Tibble-based \\
\bottomrule
\end{tabular}
\end{table}
```
